...
<?php $order = Yii::app()->session['wpmm_order']; ?>
...
<div id="wpmm-item-details-more" style="height: 300px">
    ...
    if($order['cart_form']['delivery-time'] == 'asap'){
        echo 'You want the order to be delivered <b>ASAP</b><br>';
    } else if($order['cart_form']['delivery-time'] == 'today'){
        echo 'You want the order to be delivered <b>Today by: '.$order['cart_form']['order-time'].'</b><br>';
    } else {
        echo 'You want the order to be delivered <b>On: '.$order['cart_form']['order-time'].'</b><br>';
    }
    ...
    <table border="0" width="100%">
        ...
        foreach ($order['items'] as $order_item) {
            ...
            if (!empty($order_item['instructions']))
                echo ' | <b>Instructions:</b>' . $order_item['instructions'];
            echo '</td>';
        ...
        $taxrate = ((float) $taxrate * ((float) $summ - (float) $discount)) / 100;
