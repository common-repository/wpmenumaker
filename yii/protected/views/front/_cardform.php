...
<div id="wpmm-item-details-more" style="height: 240px">
...
<div style="text-align: center">
    <img src="<?php echo MM_YII_URL.'images/credit_card.png'; ?>" width="418" height="158" border="0" alt="credit_card" style="margin-top: 5px;margin-bottom: 5px;"/><br>
</div>
    <?php
    ...
    <?php $this->endWidget(); ?>
        ...
        <div style="text-align: center">
            <img src="<?php echo MM_YII_URL.'images/paypal.png'; ?>" width="199" height="73" border="0" alt="credit_card" style="margin-top: 5px;margin-bottom: 5px;"/><br>
        </div>
       <?php
        $form = $this->beginWidget('CActiveForm', array(
            'id' => 'remindpass-form',
...
<div id="wpmm-item-details-footer">
    <div style="float: left">
            <?php echo Chtml::label('Order ammount: $'.$orderammount, '')?>
