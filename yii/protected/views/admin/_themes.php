        ...
        <tbody>
            ...
            foreach ($model->getThemesOptions() as $theme) {
                ?> <tr class="odd">
                    ...
                    echo '<td><a href="js:function(e){ return false; }" rel="tooltip" data-placement="right" data-title="<img src=\'' . $theme['thumb'] . '\' alt=\'' . $theme['fullname'] . '\' width=\'200\'/>">' . $theme['fullname'] . '</a></td>';
