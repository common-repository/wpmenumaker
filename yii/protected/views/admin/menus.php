<div class="mm-container">
    ...
    $this->widget('bootstrap.widgets.TbButton', array(
        ...
        'size' => 'large',
        'icon' => 'briefcase',
        'url' => 'admin.php?page=wpmm_menus&action=createmenu',
    ))
    ?>
    <?php
 ...
 function installSortable() {
        jQuery('#menu-grid table.items tbody').sortable({
            ...
            update : function () {
                ...
                jQuery.ajax({
                    'url': '" . admin_url() . "admin.php?page=wpmm_menus&action=sortmenu',
                    'type': 'post',
                    'data': serial,
    ...
    $this->widget('application.components.boot.TbaGridView', array(
        ...
        'columns' => array(
            ...
            array(
                ...
                'header' => 'Categories',
                'value' => '$data->rellink',
                'filter' => CHtml::activedropDownList($model->searchCategory, 'name', CHtml::listData(MMCategory::model()->findAll(array('order'=>'name')),'name','name'), array('empty'=>'Select','style'=>'width:115px;') ),
                'sortable' => false,
            ...
            array(
                ...
                'class' => 'FlagColumn',
                'callbackUrl' => admin_url() . 'admin.php?page=wpmm_menus&action=flagmenu',
                'name' => 'published',
                'header' => 'Published',
                'sortable' => true,
            ),
