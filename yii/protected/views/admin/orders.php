<div class="mm-container">
        <?php $this->widget('bootstrap.widgets.TbButton', array('url' => 'admin.php?page=wpmm_orders&action=coupons', 'label' => 'Coupons', 'icon' => 'bookmark', 'htmlOptions' => array('style' => 'margin: 5px;'))); ?>
    <?php
    $this->widget('application.components.boot.TbaExtendedGridView', array(
        ...
        'columns' => array(
            ...
            array(
             ...
             array(
                ...
                'sortable' => true,
                'type' => 'select',
                'params'=>array('action'=>'savestatus'),
