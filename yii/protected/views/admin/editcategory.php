...
if($iscreate){
    ...
    $action='updatecategory&id='.$model->id;
}
$form = $this->beginWidget('bootstrap.widgets.TbActiveForm', array(
    'id'=>'user-form',
    'type'=>'vertical',
    'action' => admin_url().'admin.php?page=wpmm_categories&action='.$action,
...
<legend>
    ...
    <?php $this->widget('bootstrap.widgets.TbButton',array('url'=>'admin.php?page=wpmm_categories','label' => 'Close','type' => 'danger','icon'=>'remove white')); ?>
    </div>
</legend>
        <?php if (!$iscreate) {
                        ...
                        'htmlOptions'=>array(
                            ...
                            jQuery.ajax({'type':'POST','success':function( data ) {
                                            ...
                                            jQuery('#imadialog').bind('click', false);
                                                },'url':'".admin_url().'admin.php?page=wpmm_menus&action=delpicturecategory&id='.$model->id."','cache':false});
                                           ",
                            ),
                )); ?>
                </div>
