...
$form = $this->beginWidget('bootstrap.widgets.TbActiveForm', array(
    'id' => 'user-form',
    'type' => 'vertical',
    'action' => admin_url().'admin.php?page=wpmm_customers&action=updateaddress&id='.$model->id,
...
<legend>
    ...
    <div align="right" style="margin-right: 10px">
        ...
        <?php $this->widget('bootstrap.widgets.TbButton', array('url' => 'admin.php?page=wpmm_customers&action=viewcustomer&id=' . $model->customer_id, 'label' => 'Close', 'type' => 'danger', 'icon' => 'remove white')); ?>
    </div>
</legend>
...
<div class="mm-container">
    ...
    <?php $this->endWidget() ?>
<div align="right" style="margin-right: 10px">
        <?php $this->widget('bootstrap.widgets.TbButton', array('url' => 'admin.php?page=wpmm_customers&action=deleteaddress&id=' . $model->id, 'label' => 'Delete Address', 'type' => 'danger', 'icon' => 'remove white')); ?>
</div>
    <?php $this->endWidget() ?>
</div>