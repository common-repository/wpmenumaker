...
$form = $this->beginWidget('bootstrap.widgets.TbActiveForm', array(
    'id' => 'user-form',
    'type' => 'vertical',
    'action' => admin_url().'admin.php?page=wpmm_customers&action=viewcustomer&id='.$model->id,
...
<legend>
    ...
    <div align="right" style="margin-right: 10px">
        ...
        <?php $this->widget('bootstrap.widgets.TbButton', array('url' => 'admin.php?page=wpmm_customers', 'label' => 'Close', 'type' => 'danger', 'icon' => 'remove white')); ?>
    </div>
</legend>
