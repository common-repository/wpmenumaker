...
class MMMenu extends CActiveRecord {
    ...
    protected function beforeSave() {
        if (parent::beforeSave()) {
            if ($this->isNewRecord) {
                $maxOrderNumber = Yii::app()->db->createCommand()->select('max(id) as max')->from(Wpmm::getTableNames('menus'))->queryScalar();
    ...
    protected function afterDelete() {
        $sql = "delete ignore from " . Wpmm::getTableNames('menu_categories') . " where menu_id = '{$this->id}'";
    ...
    public function tableName() {
        return Wpmm::getTableNames('menus');
    }
    ...
    public function relations() {
        return array(
            'categories' => array(self::MANY_MANY, 'MMCategory', Wpmm::getTableNames('menu_categories') . '(menu_id, category_id)'),
        );
    }
    ...
    public function getUrl() {
        return 'admin.php?page=wpmm_menus&action=updatemenu&id=' . $this->id;
    }

    public function getDelUrl() {
        return 'admin.php?page=wpmm_menus&action=deletemenu&id=' . $this->id;
    }
