...
class MMCategory extends CActiveRecord {
    ...
    protected function afterDelete() {
        ...
        $sql = "delete ignore from " . Wpmm::getTableNames('menu_categories') . " where category_id = '{$this->id}'";
    ...
    public function tableName() {
        return Wpmm::getTableNames('categories');
    }
    ...
    public function relations() {
        return array(
            'items' => array(self::MANY_MANY, 'MMItem', Wpmm::getTableNames('category_items') . '(category_id, item_id)'),
            'menus' => array(self::MANY_MANY, 'MMMenu', Wpmm::getTableNames('menu_categories') . '(category_id, menu_id)'),
        );
    }
    ...
    public function getUrl() {
        return 'admin.php?page=wpmm_categories&action=updatecategory&id=' . $this->id;
    }

    public function getDelUrl() {
        return 'admin.php?page=wpmm_categories&action=deletecategory&id=' . $this->id;
    }
