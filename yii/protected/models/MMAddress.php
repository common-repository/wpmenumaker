...
class MMAddress extends CActiveRecord {
    ...
    public function tableName() {
        return Wpmm::getTableNames('addresses');
    }
    ...
    public function zipvalidatesettings($attribute, $params){
        if (Helpers::ValidateZipTable($this->$attribute)) {
            return true;
        }
    ...
    public function getUrl() {
        return 'admin.php?page=wpmm_customers&action=updateaddress&id=' . $this->id.'&cid='.$this->customer_id;
    }

    public function getDelUrl() {
        return 'admin.php?page=wpmm_customers&action=deleteaddress&id=' . $this->id.'&cid='.$this->customer_id;
    }
