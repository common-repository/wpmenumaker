...
class MMOrder extends CActiveRecord {
    ...
    public function getUrl() {
        return 'admin.php?page=wpmm_orders&action=vieworder&id=' . $this->id;
    }

    public function getUserUrl(){
        if($this->customer){
            $link=CHtml::link(CHtml::encode($this->customer->c_mail), 'admin.php?page=wpmm_customers&action=viewcustomer&id=' . $this->customer->id);
            return $link;
        } else {
    ...
    public function rules() {
        return array(
            ...
            array('payment_status, tip_type, tip, promo_code, notes, customer_id, payment, trans_id, params', 'safe'),
    ...
    public function tableName() {
        return Wpmm::getTableNames('orders');
    }
